    ...
    <div class="scrollbar-inner">
        ...
        <ul class="navigation">
            ...
            <li class="@yield('security_management')"><a href="{{route('security_management.index')}}"><i class="zmdi zmdi-shield-security"></i> Security</a></li>
              @endcan
            {{--<li class="navigation__sub @yield('permission_management')"><a href="javascript:void(0)">Permission</a>--}}
                {{--<ul>--}}
                    {{--<li><a href="javascript:void(0)">Manage Permission</a></li>--}}
                    {{--<li class="@yield('permission_create')"><a href="{{route('permission.create')}}">Add Permission</a></li>--}}
                {{--</ul>--}}
            {{--</li>--}}
        </ul>
    </div>
